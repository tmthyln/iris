/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env staging` (hash: d148cfe1288de180be3a05bb84ebfe29)
// Runtime types generated with workerd@1.20260507.1 2026-02-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/service");
		durableNamespaces: "ItemQueue";
	}
	interface Env {
		...
		ITEM_QUEUE: DurableObjectNamespace<import("./src/service").ItemQueue>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VAPID_PUBLIC_KEY" | "VAPID_SUBJECT" | "CLOUDFLARE_ENV">> {}
}
